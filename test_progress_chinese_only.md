...
|3|test_script_commands_secondary.txt|測試次鏡的指令|(1)當望遠鏡不允許操作，但允許與伺服器連線，則測試伺服器對於次鏡移動的反應。<br>(2)如果望遠鏡不允許操作時，也不允許與伺服器連線測試指令，則這個檔案不測試。<br>(3)若望遠鏡允許操作，則跳過這個檔案，直接進入下個測試流程。|5|
|4|test_script_commands_telescope.txt|測試望遠鏡的指令|(1)當望遠鏡不允許操作，但允許與伺服器連線，則測試伺服器對於望遠鏡移動的反應。<br>(2)如果望遠鏡不允許操作時，也不允許與伺服器連線測試指令，則這個檔案不測試。<br>(3)若望遠鏡允許操作，則跳過這個檔案，直接進入下個測試流程。|5|
|5|test_script_commands_dome.txt|測試圓頂的指令|(1)圓頂尚未蓋好，當望遠鏡不允許操作，但允許與伺服器連線，則測試伺服器對於圓頂移動的反應。<br>(2)如果望遠鏡不允許操作時，也不允許與伺服器連線測試指令，則這個檔案不測試。<br>(3)若望遠鏡允許操作，則跳過這個檔案，直接進入下個測試流程。|5|
